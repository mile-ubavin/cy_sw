describe('Upload 7z File (ServiceLine and XML inside)', () => {
  ...
  //Admin user Upload can upload 7z file
  it('Upload 7z file', () => {
...
System Biller Id: INVALID, Personalnummern: ABBA000100279311`;
  ...
  //Admin user with HR pemission can upload 7z file
  it('Upload 7z file', () => {
    cy.loginToSupportViewAdmin();
    // Wait for login to complete
    cy.wait(1500);
